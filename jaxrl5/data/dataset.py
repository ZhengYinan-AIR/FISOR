...
class Dataset(object):
    ...
    def normalize_returns(self, max_episode_reward: float, min_episode_reward: float, scaling: float = 1000):
        self.dataset_dict["rewards"] /= max_episode_reward - min_episode_reward
